...
- [20 Carousel Outlines](#20-carousel-outlines)
- [15 Caption Templates](#15-caption-templates)
- [Reel Hook Formulas](#reel-hook-formulas)
...
### The Engagement Bait (Ethical Version) Caption
```
...
### Hashtag Rules
1. **Mix sizes every post** — don't use 30 massive hashtags (you'll get buried)
2. **Create 5 hashtag sets** and rotate them (Instagram penalizes identical hashtag blocks)
3. **Put hashtags in the caption**, not the first comment (Instagram confirmed this doesn't matter for reach, but caption placement is easier to manage)
4. **Research monthly** — hashtag effectiveness changes. Check what's working in your niche.
5. **Track performance** — use Instagram Insights to see which hashtags drive the most reach

---

## Content Calendar Framework

### The 5-Post-Per-Week System
...
1. **Educate** — How-tos, tutorials, frameworks
2. **Inspire** — Results, transformations, success stories
3. **Entertain** — Memes, relatable content, hot takes
4. **Sell** — Product features, testimonials, CTAs
...
This repo covers the frameworks. If you want complete, ready-to-customize templates:

### 50 Carousel Templates ($9)
**[Get 50 Done-for-You Carousel Templates](https://wedgemethod.gumroad.com/l/carousel-templates-50)** — 50 Canva-ready carousel templates across 10 categories. Fully customizable with your brand colors, fonts, and content. Just swap the text and post. Includes educational, storytelling, engagement, and sales carousel designs.

### Food & Recipe Instagram Templates ($17)
**[Get the Food Creator Template Pack](https://wedgemethod.gumroad.com/l/food-recipe-templates)** — 75+ templates designed specifically for food bloggers, recipe creators, and restaurant accounts. Includes recipe carousels, ingredient lists, cooking tip formats, meal prep templates, and food photography caption formulas. The complete system for food content that gets saved and shared.

---

## Contributing

Have a template that consistently drives engagement on your account? Open a PR with:
...
*Built by [WEDGE Method](https://wedgemethod.gumroad.com) — practical content creation resources that skip the fluff.*
